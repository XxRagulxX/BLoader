   ...
   public Loader() {
        System.out.println(
                "    ____                      __                    __             __ __\n"
                        ...
                        + "                /_/                                                      /____//____/");
        System.out.println("Github:https://github.com/XxRagulxX");
    }
            ...
            for(int var12 = 0; var12 < var11; ++var12) {
               ...
               if (insnNode instanceof MethodInsnNode && insnNode.getOpcode() == 182) {
                  ...
                  if (methodInsnNode.owner.equals("feign/Response$Builder") && methodInsnNode.name.equals("build") && methodInsnNode.desc.equals("()Lfeign/Response;")) {
                     ...
                     insnList.add(new MethodInsnNode(184, "com/burpsuite/burploaderkeygen/Filter", "BountyFilter", "(Ljava/lang/String;[B)[B", false));
      ...
      if (className.startsWith("burp/") && classBytes.length > 110000) {
         ...
         while(var5.hasNext()) {
            ...
            if (method.desc.equals("([Ljava/lang/Object;Ljava/lang/Object;)V") && method.instructions.size() > 20000) {
               ...
               insnList.add(new MethodInsnNode(184, "com/burpsuite/burploaderkeygen/Filter", "BurpFilter", "([Ljava/lang/Object;)V", false));
